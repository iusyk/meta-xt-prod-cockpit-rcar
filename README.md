...
usage: moulin prod-cockpit-rcar.yaml --MACHINE h3ulcb-4x2g-kf --ENABLE_ANDROID yes --ENABLE_CLUSTER yes --ENABLE_TOOLS yes --PREBUILT_DDK yes
...
optional arguments:
  ...
  --ENABLE_TOOLS {no. yes}
			...
			required for cr7.
  --PREBUILT_DDK {no,yes}
                        Use pre-built GPU drivers for domd (default value: false)
...
So, by default, you should have `domd` folder with the archives
